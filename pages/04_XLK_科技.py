...
# 页面配置
st.set_page_config(layout="wide", page_title="XLK - 科技")

# ETF 信息
ETF_CODE = "XLK"
ETF_NAME = "科技 (Technology)"
ETF_STOCKS = ["AAPL", "MSFT", "NVDA", "AVGO", "ORCL", "ADBE", "CRM", "CSCO", "INTU", "META"]
BENCHMARK = "SPY"

# 导入共享函数
import sys
sys.path.append('/Users/gengyi/investment')
